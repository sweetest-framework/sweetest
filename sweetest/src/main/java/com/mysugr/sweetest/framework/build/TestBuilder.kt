...
import com.mysugr.sweetest.framework.context.TestContextConfiguration
...
) : BaseBuilder<TestBuilder, TestAccessor>(
    TestContext(TestContextConfiguration(moduleTestingConfiguration != null)),
